...
export default function HeaderUser({
  ...
  return (
    <>
      <div
        className="relative flex items-center pb-20 text-white bg-cover min-h-500-px bg-center-top"
      ...
      >
        ...
        ></span>
        <div className="flex items-center w-full px-4 mx-auto md:px-8">
          <div className="flex flex-wrap -mx-4">
            <div className="relative w-full px-4 md:w-10/12 lg:w-7/12">
              <h1 className="mt-0 mb-4 text-5xl font-semibold leading-6">
                {title}
              </h1>
