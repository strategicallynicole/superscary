...
function Services() {
    return (
        <>
            <div className="container px-4 mx-auto mt-16 xl:px-0 lg:mt-32 f-f-p">
                <h1 className="text-3xl tracking-wider text-center text-white lg:text-5xl">Why PIVOT?</h1>
                <div className="flex justify-center w-full mt-12 lg:mt-24">
                    <div className="hidden lg:block xl:w-11/12">
                        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                            <div>
                                <div className="flex items-center justify-end pb-12 xl:pr-10">
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">Mobile App</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div className="absolute hidden border-b border-l-2 border-gray-300 h-36 lg:block" />
                                <div className="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10">
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">Highly Secure</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                                <div className="justify-center hidden w-full lg:flex">
                            ...
                            <div>
                                <div className="absolute hidden border-l-2 h-36 lg:block" />
                                <div className="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10">
                                    <div>
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">Instant Exchange</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                                <div className="justify-center hidden w-full lg:flex">
                        ...
                        <div className="grid gap-8 mt-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                            <div>
                                <div className="flex items-center justify-end pb-12 pr-10">
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">Multiple Coins</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10">
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">24/7 Support</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10">
                                    ...
                                    <div className="flex flex-col pl-8 xl:w-8/12">
                                        <h2 className="text-base font-semibold tracking-wider text-white xl:text-2xl">Insurance Program</h2>
                                        <p className="mt-3 text-base leading-7 tracking-wide text-gray-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-wrap justify-between lg:hidden">
                        ...
                        <div className="items-center justify-between w-full my-10 md:flex">
                            <div className="flex items-center">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width={62} height={62} viewBox="0 0 62 62" fill="none">
                                        <path d="M8.44443 57.0464C12.0036 57.0464 14.8889 54.147 14.8889 50.5704C14.8889 46.9939 12.0036 44.0945 8.44443 44.0945C4.88527 44.0945 2 46.9939 2 50.5704C2 54.147 4.88527 57.0464 8.44443 57.0464Z" stroke="#29AAF3" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" />
